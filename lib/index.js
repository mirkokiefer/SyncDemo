...
(function() {
  var Entry, EntryList, EntryListView, EntryView, PathView, Repository, branch, changed, changedEntries, clientName, commitChanges, entries, fetchChanges, main, omit, remotes, renderView, repo, resetEntries, trackChanges, _ref;
  ...
  commitChanges = function() {
    var data, delta, model, _i, _len, _ref1;
    data = {};
    _ref1 = changedEntries.models;
